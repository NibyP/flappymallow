...
export default restart => {
    ...
    return {
        ...
        Bird: Bird(world, 'green', {x: 50, y: 300}, {height: 60, width: 100}),
        ...
        ObstacleBottom2: Obstacle(world, 'ObstacleBottom2', 'brown', pipeSizePosB.pipeBottom.pos, pipeSizePosB.pipeBottom.size),
