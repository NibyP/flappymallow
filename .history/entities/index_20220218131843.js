...
export default restart => {
    ...
    const pipeSizePosA = getPipeSizePosPair(windowWidth * 0.9);
    ...
    return {
        ...
        ObstacleBottom2: Obstacle(world, 'ObstacleBottom2', 'teal', pipeSizePosB.pipeBottom.pos, pipeSizePosB.pipeBottom.size),
